...
{/* Mobile view */}
      <div className='sm:hidden flex flex-1 justify-end items-center'>
        ...
        <div 
          className={`${toggle ? "flex" : "hidden"} p-6 bg-black-gradient absolute top-20 right-0 mx-4 ny-2 min-w-[140px] rounded-xl sidebar`}
        >
        <ul className='list-none flex flex-col justify-end items-center flex-1 navbar'>
          {navLinks.map((nav, index) => (
